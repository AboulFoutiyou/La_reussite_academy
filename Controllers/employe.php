    ...
    if (isset($_POST['nom'], $_POST['prenom'], $_POST['date_naissance'], $_POST['email'], $_POST['telephone'], $_POST['role_id'])) {
        ...
        if ($validationResult === true) {
            if (User::exists($email)) {
                ...
                header('Location: /../La_reussite_academy/Views/ajout_employeView.php?error=exists');
                exit;
            } else {
                ...
                header('Location: /../La_reussite_academy/Views/ajout_employeView.php?success=true');
                exit;
            }
        } else {
            // Afficher les messages d'erreur sur la page d'inscription
            header('Location: /../La_reussite_academy/Views/ajout_employeView.php?error=' . $validationResult);
            exit;
        }
    } else {
        header('Location: /../La_reussite_academy/Views/ajout_employeView.php?error=missingFields');
        exit;
    }
}
